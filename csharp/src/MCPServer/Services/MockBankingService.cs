...
public class MockBankingService : IBankingService
{
    ...
    public MockBankingService(ILogger<MockBankingService> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Searching offer terms for {AccountType} matching '{Requirement}'", accountType, requirementDescription);
    ...
    {
        _logger.LogInformation("Getting offer details for {OfferId}", offerId);
    ...
    {
        _logger.LogInformation("Creating complaint for user {UserId}", userId);
    ...
    {
        _logger.LogInformation("Creating telebanker request for user {UserId}", userId);
    ...
    {
        _logger.LogInformation("Creating fulfilment request for user {UserId}", userId);
    ...
    {
        _logger.LogInformation("Creating fund transfer request for user {UserId}", userId);
